  ...
  return (
    <div className="w-full bg-white">
          ...
          <div className="flex w-full justify-between items-center h-[50px] text-slate-500">
            <ul className="flex justify-start items-center gap-8">
              <li className="flex relative justify-center items-center gap-2 text-sm after:absolute after:h-[18px] after:w-[1px] after:bg-[#afafaf] after:-right-[16px]">
                ...
                <span>quocdung@gmail.com</span>
              </li>
              <span>Hôm nay bạn sẽ mang gì ??</span>
            </ul>
            <div>
      ...
      <div className="w-white">
        <div className="w-[85%] lg:w-[90%] mx-auto ">
          <div className="h-[80px] md-lg:h-[100px] flex justify-center  items-center flex-wrap">
            ...
            <div className="md-lg:w-full w-9/12 ">
              <div className="flex justify-between md-lg:justify-center items-center flex-wrap pl-8">
                <ul className="flex justify-start items-start gap-8 font-bold uppercase md-lg:hidden text-lg">
                  <li>
                    <Link
                      to={"/"}
                      className={`p-2 block ${
                        pathname === "/" ? "text-[#f97316]" : "text-slate-600"
                      }`}
                    >
                      Trang chủ
                    </Link>
          ...
          <div className="w-3/12 md-lg:w-full">
            <div className="bg-white relative">
              <div
                ...
                className="h-[50px] bg-[#f97316] text-white flex justify-center md-lg:justify-between md-lg:px-6 items-center gap-3 font-bold text-md cursor-pointer"
              >
              ...
              <div className="w-8/12 md-lg:w-full">
                <div className="flex border h-[50px] items-center relative gap-5">
                  ...
                  <input
                    ...
                    name=""
                    id=""
                    placeholder="Bạn sẽ mang gì hôm nay !!!"
                  />
                  <button
                    onClick={search}
                    className="bg-[#f97316] right-0 absolute px-8 h-full font-semibold uppercase text-white"
                  >
                    Tìm kiếm
                  </button>
                </div>
