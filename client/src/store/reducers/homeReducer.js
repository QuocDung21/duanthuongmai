...
export const get_reviews_product = createAsyncThunk(
  "product/get_reviews_product",
  async (info, { fulfillWithValue }) => {
    try {
      const { data } = await api.post(
        "/home/customer/get-reviews-product",
        info
      );
      return fulfillWithValue(data);
    } catch (error) {
...
export const homeReducer = createSlice({
  ...
  extraReducers: {
    ...
    [get_reviews_product.fulfilled]: (state, { payload }) => {
