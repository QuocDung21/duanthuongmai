...
const EditProduct = () => {
  ...
  const switchStyles = {
    backgroundColor: state.status ? "#3CB371" : "#d9534f",
  };
  useEffect(() => {
    ...
    <div className="px-2 lg:px-7 pt-5 ">
      <div className="w-full p-4  bg-[#283046] rounded-md">
        <div className="flex justify-between items-center pb-4">
          <h1 className="text-[#d0d2d6] text-xl font-semibold uppercase">
            Cập nhật sản phẩm
          </h1>
          <Link
        ...
        <div>
          <form onSubmit={update}>
            ...
            <div className="flex flex-coll gap-2 text-center items-center text-[#d0d2d6] py-2 mb-2">
